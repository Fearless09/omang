    ...
    <section className="wrapper ipad:pt-[100px] relative z-[2] flex flex-col items-center justify-between gap-x-8 gap-y-22 pt-[100px] lg:flex-row">
      ...
      <main
        className={cn(
          ...
          "before:absolute before:-inset-5 before:-z-[1] before:rotate-15 before:animate-spin before:rounded-[50%] before:bg-gradient-to-b before:from-[#F0B8BF] before:to-[#CEC7DB] before:[animation-duration:10s]",
        )}
        // data-aos="zoom-out"
      >
        <Image
